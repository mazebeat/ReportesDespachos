...
+function (c) {
    ...
    d.prototype.getItemForDirection = function (i, h) {
        var j = i == "prev" ? -1 : 1;
        var f = this.getItemIndex(h);
        var g = (f + j) % this.$items.length;
    ...
    d.prototype.slide = function (n, i) {
...
+function (d) {
    ...
    e.prototype.show = function () {
        ...
        var h;
        var j = this.$parent && this.$parent.find("> .panel").children(".in, .collapsing");
        if (j && j.length) {
    ...
    d(document).on("click.bs.collapse.data-api", '[data-toggle="collapse"]', function (j) {
        ...
        var g = h ? "toggle" : d.extend({}, i.data(), {trigger: this});
        b.call(f, g)
    })
}(jQuery);
+function (h) {
...
+function (d) {
    ...
    b.prototype.adjustBackdrop = function () {
