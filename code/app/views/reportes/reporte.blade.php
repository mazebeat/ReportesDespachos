							...
							<table class="table table-hover">
								...
								@foreach($files as $key => $value)
									<tr>
										...
										<td>
											<a href="{{ url('download?path=' . public_path() . '/reportes/' . Auth::user()->idUsuario . '/' . basename($value))  }}" class="btn btn-primary pull-right"><i class="fa fa-download fa-fw"></i> Descargar</a>
										</td>
									</tr>
								@endforeach
								</tbody>
