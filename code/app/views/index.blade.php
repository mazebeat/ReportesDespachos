...
@section('content')
	<div ng-controller="homeController">
		...
		<div class="login-wrap">
			...
			<input type="password" name="contraseña" id="contraseña" ng-model="user.contraseña" class="form-control ng-dirty ng-invalid" placeholder="Contraseña" required>
			...
			<div class="registration">
				<label class="text-center">
					<a data-toggle="modal" href="#forgotPasswordModal">Olvidaste tu contraseña?</a> </label>
			</div>
		</div>
