...
!function (e, t, n) {
    ...
    angular.module("mgcrea.ngStrap", ["mgcrea.ngStrap.modal", "mgcrea.ngStrap.aside", "mgcrea.ngStrap.alert", "mgcrea.ngStrap.button", "mgcrea.ngStrap.select", "mgcrea.ngStrap.datepicker", "mgcrea.ngStrap.timepicker", "mgcrea.ngStrap.navbar", "mgcrea.ngStrap.tooltip", "mgcrea.ngStrap.popover", "mgcrea.ngStrap.dropdown", "mgcrea.ngStrap.typeahead", "mgcrea.ngStrap.scrollspy", "mgcrea.ngStrap.affix", "mgcrea.ngStrap.tab", "mgcrea.ngStrap.collapse"]), angular.module("mgcrea.ngStrap.affix", ["mgcrea.ngStrap.helpers.dimensions", "mgcrea.ngStrap.helpers.debounce"]).provider("$affix", function () {
        ...
        this.$get = ["$window", "debounce", "dimensions", function (t, n, a) {
            function o(o, s) {
                ...
                return d.init = function () {
                    d.$parseOffsets(), h = a.offset(o[0]).top + $, m = !o[0].style.width, p.on("scroll", d.checkPosition), p.on("click", d.checkPositionWithEventLoop), r.on("resize", d.$debouncedOnResize), d.checkPosition(), d.checkPositionWithEventLoop()
                }, d.destroy = function () {
        ...
        this.$get = ["$window", "$document", "$rootScope", "$sce", "$locale", "dateFilter", "datepickerViews", "$tooltip", "$timeout", function (t, n, a, o, i, r, s, l, u) {
            function c(t, n, a) {
                function o(e) {
                ...
                var r = l(t, angular.extend({}, e, a)), c = a.scope, p = r.$options, g = r.$scope;
                p.startView && (p.startView -= p.minView);
                var m = s(r);
                r.$views = m.views;
                var $ = m.viewDate;
                g.$mode = p.startView, g.$iconLeft = p.iconLeft, g.$iconRight = p.iconRight;
                var h = r.$views[g.$mode];
                g.$select = function (e) {
                    r.select(e)
                }, g.$selectPane = function (e) {
                    r.$selectPane(e)
                }, g.$toggleMode = function () {
                    r.setMode((g.$mode + 1) % r.$views.length)
                }, r.update = function (e) {
                    angular.isDate(e) && !isNaN(e.getTime()) && (r.$date = e, h.update.call(h, e)), r.$build(!0)
                }, r.updateDisabledDates = function (e) {
                    p.disabledDateRanges = e;
                    for (var t = 0, n = g.rows.length; n > t; t++)angular.forEach(g.rows[t], r.$setDisabledEl)
                }, r.select = function (e, t) {
                    angular.isDate(n.$dateValue) || (n.$dateValue = new Date(e)), !g.$mode || t ? (n.$setViewValue(angular.copy(e)), n.$render(), p.autoclose && !t && u(function () {
                        r.hide(!0)
                    })) : (angular.extend($, {
                        year: e.getFullYear(),
                        month: e.getMonth(),
                        date: e.getDate()
                    }), r.setMode(g.$mode - 1), r.$build())
                }, r.setMode = function (e) {
                    g.$mode = e, h = r.$views[g.$mode], r.$build()
                }, r.$build = function (e) {
                    ...
                    var t = h.steps, n = new Date(Date.UTC($.year + (t.year || 0) * e, $.month + (t.month || 0) * e, $.date + (t.day || 0) * e));
                    angular.extend($, {
                    ...
                    if (/(38|37|39|40|13)/.test(e.keyCode) && !e.shiftKey && !e.altKey) {
                        ...
                        h.onKeyDown(e), c.$digest()
                    }
                };
                var v = r.init;
                r.init = function () {
                    return d && p.useNative ? (t.prop("type", "date"), void t.css("-webkit-appearance", "textfield")) : (f && (t.prop("type", "text"), t.attr("readonly", "true"), t.on("click", i)), void v())
                };
                var y = r.destroy;
                r.destroy = function () {
                    d && p.useNative && t.off("click", i), y()
                };
                var w = r.show;
                r.show = function () {
                    w(), r.$element.on(f ? "touchstart" : "mousedown", r.$onMouseDown), p.keyboard && t.on("keydown", r.$onKeyDown)
                };
                var b = r.hide;
                return r.hide = function (e) {
                    r.$isShown && (r.$element.off(f ? "touchstart" : "mousedown", r.$onMouseDown), p.keyboard && t.off("keydown", r.$onKeyDown), b(e))
                }, r
            }

            var d = (angular.element(t.document.body), /(ip(a|o)d|iphone|android)/gi.test(t.navigator.userAgent)), f = "createTouch"in t.document && d;
            return e.lang || (e.lang = i.id), c.defaults = e, c
        }]
    }).directive("bsDatepicker", ["$window", "$parse", "$q", "$locale", "dateFilter", "$datepicker", "$dateParser", function (e, t, n, a, o, i, r) {
        var s = (i.defaults, /(ip(a|o)d|iphone|android)/gi.test(e.navigator.userAgent));
        return {
            restrict: "EAC", require: "ngModel", link: function (e, t, n, a) {
                ...
                function u(e) {
                    if (angular.isDate(e)) {
                        var t = isNaN(d.$options.minDate) || e.getTime() >= d.$options.minDate, n = isNaN(d.$options.maxDate) || e.getTime() <= d.$options.maxDate, o = t && n;
                        a.$setValidity("date", o), a.$setValidity("min", t), a.$setValidity("max", n), o && (a.$dateValue = e)
                    }
                }
                ...
                angular.forEach(["placement", "container", "delay", "trigger", "keyboard", "html", "animation", "template", "autoclose", "dateType", "dateFormat", "modelDateFormat", "dayFormat", "strictFormat", "startWeek", "startDate", "useNative", "lang", "startView", "minView", "iconLeft", "iconRight", "daysOfWeekDisabled"], function (e) {
                    ...
                    d && angular.isDefined(e) && (angular.isString(e) && (e = !!e.match(/true|,?(datepicker),?/i)), e === !0 ? d.show() : d.hide())
                });
                var d = i(t, a, c);
                c = d.$options, s && c.useNative && (c.dateFormat = "yyyy-MM-dd");
                ...
                angular.forEach(["minDate", "maxDate"], function (e) {
                    angular.isDefined(n[e]) && n.$observe(e, function (t) {
                        d.$options[e] = f.getDateForAttribute(e, t), !isNaN(d.$options[e]) && d.$build(!1), u(a.$dateValue)
                    })
                }), e.$watch(n.ngModel, function () {
                    d.update(a.$dateValue)
                }, !0), angular.isDefined(n.disabledDates) && e.$watch(n.disabledDates, function (e, t) {
                    e = l(e), t = l(t), e && d.updateDisabledDates(e)
                }), a.$parsers.unshift(function (e) {
                    if (!e)return void a.$setValidity("date", !0);
                    var t = f.parse(e, a.$dateValue);
                    return !t || isNaN(t.getTime()) ? void a.$setValidity("date", !1) : (u(t), "string" === c.dateType ? o(t, c.modelDateFormat || c.dateFormat) : "number" === c.dateType ? a.$dateValue.getTime() : "iso" === c.dateType ? a.$dateValue.toISOString() : new Date(a.$dateValue))
        ...
        this.$get = ["$locale", "$sce", "dateFilter", "$dateParser", function (n, a, o, i) {
            return function (r) {
                var s = r.$scope, l = r.$options, u = i(), c = n.DATETIME_FORMATS.SHORTDAY, d = c.slice(l.startWeek).concat(c.slice(0, l.startWeek)), f = a.trustAsHtml('<th class="dow text-center">' + d.join('</th><th class="dow text-center">') + "</th>"), p = r.$date || (l.startDate ? u.getDateForAttribute("startDate", l.startDate) : new Date), g = {
                    year: p.getFullYear(),
                    month: p.getMonth(),
                    date: p.getDate()
                }, m = (6e4 * p.getTimezoneOffset(), [{
                    format: l.dayFormat,
                    split: 7,
                    steps: {month: 1},
                    update: function (e, t) {
                        !this.built || t || e.getFullYear() !== g.year || e.getMonth() !== g.month ? (angular.extend(g, {
                            ...
                            date: r.$date.getDate()
                        }), r.$build()) : e.getDate() !== g.date && (g.date = r.$date.getDate(), r.$updateSelected())
                    },
                    build: function () {
                        var n = new Date(g.year, g.month, 1), a = n.getTimezoneOffset(), i = new Date(+n - 864e5 * t(n.getDay() - l.startWeek, 7)), u = i.getTimezoneOffset(), c = (new Date).toDateString();
                        u !== a && (i = new Date(+i + 6e4 * (u - a)));
                        for (var d, p = [], m = 0; 42 > m; m++)d = new Date(i.getFullYear(), i.getMonth(), i.getDate() + m), p.push({
                            date: d,
                            isToday: d.toDateString() === c,
                            label: o(d, this.format),
                            selected: r.$date && this.isSelected(d),
                            muted: d.getMonth() !== g.month,
                            disabled: this.isDisabled(d)
                        });
                        s.title = o(n, "MMMM yyyy"), s.showLabels = !0, s.labels = f, s.rows = e(p, this.split), this.built = !0
                    },
                    isSelected: function (e) {
                        return r.$date && e.getFullYear() === r.$date.getFullYear() && e.getMonth() === r.$date.getMonth() && e.getDate() === r.$date.getDate()
                    },
                    ...
                    onKeyDown: function (e) {
                        if (r.$date) {
                            var t, n = r.$date.getTime();
                            37 === e.keyCode ? t = new Date(n - 864e5) : 38 === e.keyCode ? t = new Date(n - 6048e5) : 39 === e.keyCode ? t = new Date(n + 864e5) : 40 === e.keyCode && (t = new Date(n + 6048e5)), this.isDisabled(t) || r.select(t, !0)
                        }
                    }
                }, {
                    name: "month", format: "MMM", split: 4, steps: {year: 1}, update: function (e) {
                        this.built && e.getFullYear() === g.year ? e.getMonth() !== g.month && (angular.extend(g, {
                            month: r.$date.getMonth(),
                            date: r.$date.getDate()
                        }), r.$updateSelected()) : (angular.extend(g, {
                            year: r.$date.getFullYear(),
                            month: r.$date.getMonth(),
                            date: r.$date.getDate()
                        }), r.$build())
                        ...
                        for (var t, n = (new Date(g.year, 0, 1), []), a = 0; 12 > a; a++)t = new Date(g.year, a, 1), n.push({
                            ...
                            selected: r.$isSelected(t),
                            disabled: this.isDisabled(t)
                        });
                        s.title = o(t, "yyyy"), s.showLabels = !1, s.rows = e(n, this.split), this.built = !0
                    }, isSelected: function (e) {
                        return r.$date && e.getFullYear() === r.$date.getFullYear() && e.getMonth() === r.$date.getMonth()
                    }, isDisabled: function (e) {
                        var t = +new Date(e.getFullYear(), e.getMonth() + 1, 0);
                        return t < l.minDate || e.getTime() > l.maxDate
                    }, onKeyDown: function (e) {
                        if (r.$date) {
                            var t = r.$date.getMonth(), n = new Date(r.$date);
                            37 === e.keyCode ? n.setMonth(t - 1) : 38 === e.keyCode ? n.setMonth(t - 4) : 39 === e.keyCode ? n.setMonth(t + 1) : 40 === e.keyCode && n.setMonth(t + 4), this.isDisabled(n) || r.select(n, !0)
                        }
                    }
                }, {
                    name: "year", format: "yyyy", split: 4, steps: {year: 12}, update: function (e, t) {
                        !this.built || t || parseInt(e.getFullYear() / 20, 10) !== parseInt(g.year / 20, 10) ? (angular.extend(g, {
                            ...
                            month: r.$date.getMonth(),
                            date: r.$date.getDate()
                        }), r.$build()) : e.getFullYear() !== g.year && (angular.extend(g, {
                            year: r.$date.getFullYear(),
                            month: r.$date.getMonth(),
                            date: r.$date.getDate()
                        }), r.$updateSelected())
                    }, build: function () {
                        for (var t, n = g.year - g.year % (3 * this.split), a = [], i = 0; 12 > i; i++)t = new Date(n + i, 0, 1), a.push({
                            date: t,
                            label: o(t, this.format),
                            selected: r.$isSelected(t),
                            disabled: this.isDisabled(t)
                        });
                        s.title = a[0].label + "-" + a[a.length - 1].label, s.showLabels = !1, s.rows = e(a, this.split), this.built = !0
                    }, isSelected: function (e) {
                        return r.$date && e.getFullYear() === r.$date.getFullYear()
                    }, isDisabled: function (e) {
                        var t = +new Date(e.getFullYear() + 1, 0, 0);
                        return t < l.minDate || e.getTime() > l.maxDate
                    }, onKeyDown: function (e) {
                        if (r.$date) {
                            var t = r.$date.getFullYear(), n = new Date(r.$date);
                            37 === e.keyCode ? n.setYear(t - 1) : 38 === e.keyCode ? n.setYear(t - 4) : 39 === e.keyCode ? n.setYear(t + 1) : 40 === e.keyCode && n.setYear(t + 4), this.isDisabled(n) || r.select(n, !0)
                        }
                    }
                }]);
                return {views: l.minView ? Array.prototype.slice.call(m, l.minView) : m, viewDate: g}
            }
        }]
        ...
        this.$get = ["$window", "$rootScope", "$tooltip", function (t, n, a) {
            function o(t, o) {
                ...
                var d = l.show;
                l.show = function () {
                    d(), u.keyboard && l.$element.on("keydown", l.$onKeyDown), i.on("click", s), c.hasClass("dropdown") && c.addClass("open")
                };
                var f = l.hide;
                return l.hide = function () {
                    l.$isShown && (u.keyboard && l.$element.off("keydown", l.$onKeyDown), i.off("click", s), c.hasClass("dropdown") && c.removeClass("open"), f())
                }, l
            }
        ...
        this.$get = ["$locale", "dateFilter", function (r, s) {
            var l = function (l) {
                ...
                return m.init = function () {
                    ...
                    var o = a ? d(a) : f, i = a ? u(a) : p, r = o.exec(t);
                    if (!r)return !1;
                    for (var l = (new e).fromDate(n && !isNaN(n.getTime()) ? n : new Date(1970, 0, 1, 0)), c = 0; c < r.length - 1; c++)i[c] && i[c].call(l, r[c + 1]);
                    return l.toDate()
        ...
        this.$get = ["$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "$timeout", "$sce", "dimensions", function (n, a, o, i, r, s, l, u, c) {
            function d(t) {
                ...
                function i() {
                    d.$emit(u.prefixEvent + ".hide", s), h.removeClass(u.prefixClass + "-open"), u.animation && h.removeClass(u.prefixClass + "-with-" + u.animation)
                }
                ...
                u.element || u.container || (u.container = "body"), g(["title", "content"], function (e) {
                    ...
                    var n = angular.element(e);
                    return p(u.contentTemplate).then(function (e) {
                        var a = f('[ng-bind="content"]', n[0]).removeAttr("ng-bind").html(e);
                        return t.template || a.next().remove(), n[0].outerHTML
                    })
                }));
                var y, w, b = angular.element('<div class="' + u.prefixClass + '-backdrop"/>');
                return s.$promise.then(function (e) {
                    angular.isObject(e) && (e = e.data), u.html && (e = e.replace(v, 'ng-bind-html="')), e = m.apply(e), y = o(e), s.init()
                }), s.init = function () {
                    u.show && d.$$postDigest(function () {
                        s.show()
                    })
                }, s.destroy = function () {
                    w && (w.remove(), w = null), b && (b.remove(), b = null), d.$destroy()
                }, s.show = function () {
                    if (!d.$isShown && !d.$emit(u.prefixEvent + ".show.before", s).defaultPrevented) {
                        var e;
                        e = angular.isElement(u.container) ? u.container : u.container ? f(u.container) : null;
                        var t = u.container ? null : u.element;
                        w = s.$element = y(d, function () {
                        }), w.css({display: "block"}).addClass(u.placement), u.animation && (u.backdrop && b.addClass(u.backdropAnimation), w.addClass(u.animation)), u.backdrop && l.enter(b, h, null);
                        var a = l.enter(w, e, t, n);
                        a && a.then && a.then(n), d.$isShown = !0, d.$$phase || d.$root && d.$root.$$phase || d.$digest();
                        var o = w[0];
                        $(function () {
                            o.focus()
                        }), h.addClass(u.prefixClass + "-open"), u.animation && h.addClass(u.prefixClass + "-with-" + u.animation), u.backdrop && (w.on("click", r), b.on("click", r)), u.keyboard && w.on("keyup", s.$onKeyUp)
                    }
                }, s.hide = function () {
            ...
            var g = angular.forEach, m = String.prototype.trim, $ = n.requestAnimationFrame || n.setTimeout, h = angular.element(n.document.body), v = /ng-bind="/gi;
            return d
        }]
        ...
        this.$get = ["$window", "$document", "$rootScope", "dimensions", "debounce", "throttle", function (a, o, i, r, s, l) {
            ...
            function c(o) {
                ...
                var h, v, y, w, b, D, k, S, T = {}, x = T.$trackedElements = [], C = [];
                return T.init = function () {
                    this.$$count = 1, w = s(this.checkPosition, c.debounce), b = l(this.checkPosition, c.throttle), m.on("click", this.checkPositionWithEventLoop), d.on("resize", w), m.on("scroll", b), D = s(this.checkOffsets, c.debounce), h = i.$on("$viewContentLoaded", D), v = i.$on("$includeContentLoaded", D), D(), $ && (e[$] = T)
                }, T.destroy = function () {
                    this.$$count--, this.$$count > 0 || (m.off("click", this.checkPositionWithEventLoop), d.off("resize", w), m.off("scroll", w), h(), v(), $ && delete e[$])
                }, T.checkPosition = function () {
                    if (C.length) {
                        if (S = (g ? a.pageYOffset : m.prop("scrollTop")) || 0, k = Math.max(a.innerHeight, f.prop("clientHeight")), S < C[0].offsetTop && y !== C[0].target)return T.$activateElement(C[0]);
                        for (var e = C.length; e--;)if (!angular.isUndefined(C[e].offsetTop) && null !== C[e].offsetTop && y !== C[e].target && !(S < C[e].offsetTop || C[e + 1] && S > C[e + 1].offsetTop))return T.$activateElement(C[e])
                    }
        ...
        this.$get = ["$window", "$document", "$rootScope", "$tooltip", function (t, n, a, o) {
            function i(t, n, a) {
                ...
                var u = i.show;
                i.show = function () {
                    u(), r.multiple && i.$element.addClass("select-multiple"), i.$element.on(s ? "touchstart" : "mousedown", i.$onMouseDown), r.keyboard && t.on("keydown", i.$onKeyDown)
                };
                var c = i.hide;
        ...
        var e = this.defaults = {
            ...
            o.$options = angular.copy(e), angular.forEach(["animation", "navClass", "activeClass"], function (e) {
                angular.isDefined(a[e]) && (o.$options[e] = a[e])
            }), t.$navClass = o.$options.navClass, t.$activeClass = o.$options.activeClass, o.$panes = t.$panes = [], o.$viewChangeListeners = [], o.$push = function (e) {
                o.$panes.push(e)
            }, o.$remove = function (e) {
                ...
                o.$panes.$active = e, o.$viewChangeListeners.forEach(function (e) {
                    e()
                })
            }
        };
        ...
        return {
            ...
            link: function (e, t, n, a) {
                var o = a[0], i = a[1];
                o && (i.$viewChangeListeners.push(function () {
                    o.$setViewValue(i.$panes.$active)
                }), o.$formatters.push(function (e) {
                    return i.$setActive(1 * e), e
                }))
            }
        }
        ...
        this.$get = ["$window", "$document", "$rootScope", "$sce", "$locale", "dateFilter", "$tooltip", "$timeout", function (t, n, a, o, i, r, s, l) {
            function u(t, n, a) {
                function o(e, n) {
                ...
                var f = s(t, angular.extend({}, e, a)), p = a.scope, g = f.$options, m = f.$scope, $ = 0, h = n.$dateValue || new Date, v = {
                    hour: h.getHours(),
                    meridian: h.getHours() < 12,
                    minute: h.getMinutes(),
                    second: h.getSeconds(),
                    millisecond: h.getMilliseconds()
                }, y = i.DATETIME_FORMATS[g.timeFormat] || g.timeFormat, w = /(h+)([:\.])?(m+)[ ]?(a?)/i.exec(y).slice(1);
                m.$iconUp = g.iconUp, m.$iconDown = g.iconDown, m.$select = function (e, t) {
                    ...
                    angular.isDate(e) && !isNaN(e.getTime()) ? (f.$date = e, angular.extend(v, {
                        hour: e.getHours(),
                        minute: e.getMinutes(),
                        second: e.getSeconds(),
                    ...
                    (!n.$dateValue || isNaN(n.$dateValue.getTime())) && (n.$dateValue = new Date(1970, 0, 1)), angular.isDate(e) || (e = new Date(e)), 0 === t ? n.$dateValue.setHours(e.getHours()) : 1 === t && n.$dateValue.setMinutes(e.getMinutes()), n.$setViewValue(angular.copy(n.$dateValue)), n.$render(), g.autoclose && !a && l(function () {
                        f.hide(!0)
                    })
                    ...
                    for (e = 0; e < g.length; e++)t = new Date(1970, 0, 1, v.hour - (n - e) * g.hourStep), a.push({
                        date: t,
                        label: r(t, w[0]),
                    ...
                    var o, i = [];
                    for (e = 0; e < g.length; e++)o = new Date(1970, 0, 1, 0, v.minute - (n - e) * g.minuteStep), i.push({
                        date: o,
                        label: r(o, w[2]),
                    ...
                    var s = [];
                    for (e = 0; e < g.length; e++)s.push([a[e], i[e]]);
                    m.rows = s, m.showAM = !!w[3], m.isAM = (f.$date || a[n].date).getHours() < 12, m.timeSeparator = w[1], f.$isBuilt = !0
                    ...
                    var n;
                    return 0 === t ? n = e.getTime() + 6e4 * v.minute : 1 === t && (n = e.getTime() + 36e5 * v.hour), n < 1 * g.minTime || n > 1 * g.maxTime
                }, m.$arrowAction = function (e, t) {
                    "picker" === g.arrowBehavior ? f.$setTimeByStep(e, t) : f.$moveIndex(e, t)
                }, f.$setTimeByStep = function (e, t) {
                    {
                        var n = new Date(f.$date), a = n.getHours(), o = (r(n, "h").length, n.getMinutes());
                        r(n, "mm").length
                    }
                    0 === t ? n.setHours(a - parseInt(g.hourStep, 10) * e) : n.setMinutes(o - parseInt(g.minuteStep, 10) * e), f.select(n, t, !0)
                }, f.$moveIndex = function (e, t) {
                    var n;
                    0 === t ? (n = new Date(1970, 0, 1, v.hour + e * g.length, v.minute), angular.extend(v, {hour: n.getHours()})) : 1 === t && (n = new Date(1970, 0, 1, v.hour, v.minute + e * g.length * g.minuteStep), angular.extend(v, {minute: n.getMinutes()})), f.$build()
                    ...
                    if (/(38|37|39|40|13)/.test(e.keyCode) && !e.shiftKey && !e.altKey) {
                        ...
                        var t = new Date(f.$date), n = t.getHours(), a = r(t, "h").length, i = t.getMinutes(), s = r(t, "mm").length, l = /(37|39)/.test(e.keyCode), u = 2 + 1 * !!w[3];
                        l && (37 === e.keyCode ? $ = 1 > $ ? u - 1 : $ - 1 : 39 === e.keyCode && ($ = u - 1 > $ ? $ + 1 : 0));
                        var c = [0, a];
                        0 === $ ? (38 === e.keyCode ? t.setHours(n - parseInt(g.hourStep, 10)) : 40 === e.keyCode && t.setHours(n + parseInt(g.hourStep, 10)), c = [0, a]) : 1 === $ ? (38 === e.keyCode ? t.setMinutes(i - parseInt(g.minuteStep, 10)) : 40 === e.keyCode && t.setMinutes(i + parseInt(g.minuteStep, 10)), c = [a + 1, a + 1 + s]) : 2 === $ && (l || f.switchMeridian(), c = [a + 1 + s + 1, a + 1 + s + 3]), f.select(t, $, !0), o(c[0], c[1]), p.$digest()
                    }
                };
                var b = f.init;
                f.init = function () {
                    return c && g.useNative ? (t.prop("type", "time"), void t.css("-webkit-appearance", "textfield")) : (d && (t.prop("type", "text"), t.attr("readonly", "true"), t.on("click", u)), void b())
                };
                var D = f.destroy;
                f.destroy = function () {
                    c && g.useNative && t.off("click", u), D()
                };
                var k = f.show;
                f.show = function () {
                    k(), f.$element.on(d ? "touchstart" : "mousedown", f.$onMouseDown), g.keyboard && t.on("keydown", f.$onKeyDown)
                };
                var S = f.hide;
                return f.hide = function (e) {
                    f.$isShown && (f.$element.off(d ? "touchstart" : "mousedown", f.$onMouseDown), g.keyboard && t.off("keydown", f.$onKeyDown), S(e))
                }, f
            }
    ...
    }).directive("bsTimepicker", ["$window", "$parse", "$q", "$locale", "dateFilter", "$timepicker", "$dateParser", function (e, t, n, a, o, i, r) {
        {
        ...
        return {
            restrict: "EAC", require: "ngModel", link: function (e, t, n, a) {
                function u(e) {
                    if (angular.isDate(e)) {
                        var t = isNaN(d.minTime) || new Date(e.getTime()).setFullYear(1970, 0, 1) >= d.minTime, n = isNaN(d.maxTime) || new Date(e.getTime()).setFullYear(1970, 0, 1) <= d.maxTime, o = t && n;
                        a.$setValidity("date", o), a.$setValidity("min", t), a.$setValidity("max", n), o && (a.$dateValue = e)
                    }
                }

                function c() {
                    return !a.$dateValue || isNaN(a.$dateValue.getTime()) ? "" : o(a.$dateValue, d.timeFormat)
                }

                var d = {scope: e, controller: a};
                ...
                }), l && (d.useNative || s.useNative) && (d.timeFormat = "HH:mm");
                var f = i(t, a, d);
                d = f.$options;
                var p = r({format: d.timeFormat, lang: d.lang});
                angular.forEach(["minTime", "maxTime"], function (e) {
                    angular.isDefined(n[e]) && n.$observe(e, function (t) {
                        f.$options[e] = p.getTimeForAttribute(e, t), !isNaN(f.$options[e]) && f.$build(), u(a.$dateValue)
                    })
                }), e.$watch(n.ngModel, function () {
                    f.update(a.$dateValue)
                }, !0), a.$parsers.unshift(function (e) {
                    if (!e)return void a.$setValidity("date", !0);
                    var t = angular.isDate(e) ? e : p.parse(e, a.$dateValue);
                    return !t || isNaN(t.getTime()) ? void a.$setValidity("date", !1) : (u(t), "string" === d.timeType ? o(t, d.modelTimeFormat || d.timeFormat) : "number" === d.timeType ? a.$dateValue.getTime() : "iso" === d.timeType ? a.$dateValue.toISOString() : new Date(a.$dateValue))
                }), a.$formatters.push(function (e) {
                    var t;
                    return t = angular.isUndefined(e) || null === e ? 0 / 0 : angular.isDate(e) ? e : "string" === d.timeType ? p.parse(e, null, d.modelTimeFormat) : new Date(e), a.$dateValue = t, c()
                }), a.$render = function () {
                    t.val(c())
                }, e.$on("$destroy", function () {
        ...
        this.$get = ["$window", "$rootScope", "$compile", "$q", "$templateCache", "$http", "$animate", "dimensions", "$$rAF", "$timeout", function (n, a, o, i, r, s, l, u, c, d) {
            function f(t, n) {
                function i() {
                    k.$emit(D.prefixEvent + ".show", w)
                }

                function r() {
                    return k.$emit(D.prefixEvent + ".hide", w), F && "focus" === D.trigger ? t[0].blur() : void y()
                }

                function s() {
                    return "body" === D.container ? u.offset(D.target[0] || t[0]) : u.position(D.target[0] || t[0])
                }
                ...
                function y() {
                    clearTimeout(T), V && (V.$destroy(), V = null), M && (M.remove(), M = w.$element = null)
                }

                var w = {}, b = t[0].nodeName.toLowerCase(), D = w.$options = angular.extend({}, e, n);
                w.$promise = g(D.template);
                var k = w.$scope = D.scope && D.scope.$new() || a.$new();
                if (D.delay && angular.isString(D.delay)) {
                    var S = D.delay.split(",").map(parseFloat);
                    D.delay = S.length > 1 ? {show: S[0], hide: S[1]} : S[0]
                }
                D.title && (w.$scope.title = D.title), k.$setEnabled = function (e) {
                ...
                }, w.$isShown = k.$isShown = !1;
                var T, x;
                D.contentTemplate && (w.$promise = w.$promise.then(function (e) {
                    var t = angular.element(e);
                    return g(D.contentTemplate).then(function (e) {
                        var n = p('[ng-bind="content"]', t[0]);
                        return n.length || (n = p('[ng-bind="title"]', t[0])), n.removeAttr("ng-bind").html(e), t[0].outerHTML
                    })
                }));
                var C, M, E, A, V;
                w.$promise.then(function (e) {
                    angular.isObject(e) && (e = e.data), D.html && (e = e.replace(h, 'ng-bind-html="')), e = m.apply(e), E = e, C = o(e), w.init()
                }), w.init = function () {
                    D.delay && angular.isNumber(D.delay) && (D.delay = {
                        show: D.delay,
                        hide: D.delay
                    }), "self" === D.container ? A = t : angular.isElement(D.container) ? A = D.container : D.container && (A = p(D.container));
                    var e = D.trigger.split(" ");
                    angular.forEach(e, function (e) {
                        "click" === e ? t.on("click", w.toggle) : "manual" !== e && (t.on("hover" === e ? "mouseenter" : "focus", w.enter), t.on("hover" === e ? "mouseleave" : "blur", w.leave), "button" === b && "hover" !== e && t.on($ ? "touchstart" : "mousedown", w.$onFocusElementMouseDown))
                    }), D.target && (D.target = angular.isElement(D.target) ? D.target : p(D.target)), D.show && k.$$postDigest(function () {
                        "focus" === D.trigger ? t[0].focus() : w.show()
                    })
                }, w.destroy = function () {
                    for (var e = D.trigger.split(" "), n = e.length; n--;) {
                        var a = e[n];
                        "click" === a ? t.off("click", w.toggle) : "manual" !== a && (t.off("hover" === a ? "mouseenter" : "focus", w.enter), t.off("hover" === a ? "mouseleave" : "blur", w.leave), "button" === b && "hover" !== a && t.off($ ? "touchstart" : "mousedown", w.$onFocusElementMouseDown))
                    }
                    D.autoClose && w.$isShown && null !== M && (v.off("click"), M.off("click")), y(), k.$destroy()
                }, w.enter = function () {
                    return clearTimeout(T), x = "in", D.delay && D.delay.show ? void(T = setTimeout(function () {
                        "in" === x && w.show()
                    }, D.delay.show)) : w.show()
                }, w.show = function () {
                    if (D.bsEnabled) {
                        k.$emit(D.prefixEvent + ".show.before", w);
                        var e = D.container ? A : null, n = D.container ? null : t;
                        M && y(), V = w.$scope.$new(), M = w.$element = C(V, function () {
                        }), M.css({
                            top: "-9999px",
                            left: "-9999px",
                            display: "block",
                            visibility: "hidden"
                        }).addClass(D.placement), D.animation && M.addClass(D.animation), D.type && M.addClass(D.prefixClass + "-" + D.type), D.customClass && M.addClass(D.customClass);
                        var a = l.enter(M, e, n, i);
                        a && a.then && a.then(i), w.$isShown = k.$isShown = !0, k.$$phase || k.$root && k.$root.$$phase || k.$digest(), c(function () {
                            w.$applyPlacement(), M && M.css({visibility: "visible"})
                        }), D.keyboard && ("focus" !== D.trigger ? (w.focus(), M.on("keyup", w.$onKeyUp)) : t.on("keyup", w.$onFocusKeyUp)), D.autoClose && (M.on("click", function (e) {
                            e.stopPropagation()
                        }), d(function () {
                            v.on("click", function () {
                                w.hide()
                    ...
                    return clearTimeout(T), x = "out", D.delay && D.delay.hide ? void(T = setTimeout(function () {
                        "out" === x && w.hide()
                    }, D.delay.hide)) : w.hide()
                };
                var F;
                return w.hide = function (e) {
                    if (w.$isShown) {
                        k.$emit(D.prefixEvent + ".hide.before", w), F = e;
                        var t = l.leave(M, r);
                        t && t.then && t.then(r), w.$isShown = k.$isShown = !1, k.$$phase || k.$root && k.$root.$$phase || k.$digest(), D.keyboard && null !== M && M.off("keyup", w.$onKeyUp), D.autoClose && null !== M && (v.off("click"), M.off("click"))
                    }
                }, w.toggle = function () {
                    w.$isShown ? w.leave() : w.enter()
                }, w.focus = function () {
                    M[0].focus()
                }, w.setEnabled = function (e) {
                    D.bsEnabled = e
                }, w.$applyPlacement = function () {
                    if (M) {
                        var e = s(), t = M.prop("offsetWidth"), n = M.prop("offsetHeight"), a = f(D.placement, e, t, n);
                        a.top += "px", a.left += "px", M.css(a)
                    }
                }, w.$onKeyUp = function (e) {
                    27 === e.which && w.$isShown && (w.hide(), e.stopPropagation())
                }, w.$onFocusKeyUp = function (e) {
                    27 === e.which && (t[0].blur(), e.stopPropagation())
                }, w.$onFocusElementMouseDown = function (e) {
                    e.preventDefault(), e.stopPropagation(), w.$isShown ? t[0].blur() : t[0].focus()
                }, w
            }
            ...
            var m = String.prototype.trim, $ = "createTouch"in n.document, h = /ng-bind="/gi, v = angular.element(n.document);
            return f
        }]
        ...
        this.$get = ["$window", "$rootScope", "$tooltip", function (t, n, a) {
            function o(t, n, o) {
                ...
                var u = i.show;
                i.show = function () {
                    u(), i.$element.on("mousedown", i.$onMouseDown), r.keyboard && t.on("keydown", i.$onKeyDown)
                };
                var c = i.hide;
                return i.hide = function () {
        ...
        return {
            restrict: "EAC", require: "ngModel", link: function (e, t, a, s) {
                ...
                e.$watch(a.ngModel, function (t) {
                    ...
                    n = angular.isObject(n) ? n.label : n, t.val(n ? n.toString().replace(/<(?:.|\n)*?>/gm, "").trim() : "")
                }, e.$on("$destroy", function () {
