    ...
    e.prototype.init = function () {
        ...
        if (this.eventsLastMonth = [], this.eventsThisMonth = [], this.eventsNextMonth = [], this.options.events.length)if (this.options.multiDayEvents) {
            if (this.eventsThisMonth = a(this.options.events).filter(function () {
                    return this._clndrStartDateObject.format("YYYY-MM") == b.format("YYYY-MM") || this._clndrEndDateObject.format("YYYY-MM") == b.format("YYYY-MM")
                ...
                this.eventsLastMonth = a(this.options.events).filter(function () {
                    return this._clndrStartDateObject.format("YYYY-MM") == d.format("YYYY-MM") || this._clndrEndDateObject.format("YYYY-MM") == d.format("YYYY-MM")
                }).toArray(), this.eventsNextMonth = a(this.options.events).filter(function () {
                    return this._clndrStartDateObject.format("YYYY-MM") == e.format("YYYY-MM") || this._clndrEndDateObject.format("YYYY-MM") == e.format("YYYY-MM")
                }).toArray()
            }
