...
AmCharts.AmGraph = AmCharts.Class({
    ...
    createRadarGraph: function () {
        ...
        if (a) {
            var c = this.chart, d = {
                type: "rollOverGraphItem", item: a, index: a.index, graph: this, target: this, chart: this.chart,
                event: b
            };
...
AmCharts.wedge = function (a, b, c, d, e, f, g, h, k, l, m, n) {
    ...
    359.94 < s && (s = 359.94);
    e >= s && (e = s);
    var v = 1 / 180 * Math.PI, s = b + Math.sin(d * v) * h, w = c - Math.cos(d * v) * q, t = b + Math.sin(d * v) * f, u = c - Math.cos(d * v) * g, y = b + Math.sin((d + e) * v) * f, E = c - Math.cos((d + e) * v) * g, A = b + Math.sin((d + e) * v) * h, v = c - Math.cos((d + e) * v) * q, z = {
